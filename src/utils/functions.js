...
const SecretKey = process.env.REACT_APP_CLIENT_SECRET;
...
export const testAuthGetter = async (authTok) => {
    try {
        const response = await axios.post(
            `https://www.strava.com/api/v3/oauth/token?client_id=${UserId}&client_secret=${SecretKey}&code=${authTok}&grant_type=authorization_code`
        );
